...
<div class="total-display-container">
    <table width="100%" cellspacing="0px" border="0"
        ...
        <tr>
            <td width="33.33%"></td>
            <td class="border-0 total-table-attribute-label" width="33.33%">@lang('pdf_subtotal')</td>
            <td class="border-0 item-cell total-table-attribute-value" width="33.33%">{!! format_money_pdf($estimate->sub_total, $estimate->customer->currency) !!}</td>
        </tr>
        ...
        @if ($estimate->discount > 0)
            @if ($estimate->discount_per_item === 'NO')
                <tr>
                    <td width="33.33%"></td>
                    <td class="pl-10 border-0 total-table-attribute-label" width="33.33%">
                    ...
                    <td class="text-right border-0 item-cell total-table-attribute-value" width="33.33%">
                        @if ($estimate->discount_type === 'fixed')
        ...
        @if ($estimate->tax_per_item === 'YES')
            @foreach ($taxes as $tax)
                <tr>
                    <td width="33.33%"></td>
                    <td class="border-0 total-table-attribute-label" width="33.33%">
                        {{ $tax->name . ' (' . $tax->percent . '%)' }}
                    </td>
                    <td class="py-2 border-0 item-cell total-table-attribute-value" width="33.33%">
        ...
        @else
            @foreach ($estimate->taxes as $tax)
                <tr>
                    ...
                    <td class="border-0 item-cell total-table-attribute-value" width="33.33%">
                        {!! format_money_pdf($tax->amount, $estimate->customer->currency) !!}
                    </td>
                </tr>
            @endforeach
        ...
        <tr>
            <td class="py-3" width="33.33%"></td>
            <td class="py-3" width="33.33%"></td>
            <td class="py-3" width="33.33%"></td>
        </tr>
        <tr>
            <td class="py-3" width="33.33%"></td>
            <td class="border-0 total-border-left total-table-attribute-label total-label" width="33.33%">
                @lang('pdf_total')</td>
            <td class="py-8 border-0 total-border-right item-cell total-table-attribute-value total-value"
                width="33.33%">
        ...
        <tr>
            ...
            <td width="33.33%">
                <span style="font-style: italic">
                    ({{ convert_price_to_thai_string_pdf($estimate->total) }})
                </span>
            </td>
        </tr>
    </table>
